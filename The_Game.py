...
def intro():
    ...
    input ("---")
    print ("The figure presented you a random attack (10 - 15), a random speed (5 - 15), and a random health (5 - 10)")
    ...
    input ("---")
    print ("The figure presented you a random attack (10 - 15), a random speed (5 - 10), and a random health (5 - 15)")
    ...
    input ("---")
    print ("The figure presented you a random attack (5 - 10), a random speed (10 - 15), and a random health (5 - 15)")
